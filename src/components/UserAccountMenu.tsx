      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-64 bg-slate-900 border border-slate-800 text-slate-100 p-2 rounded-2xl shadow-2xl z-[1000]">
          ...
          <DropdownMenuItem 
            ...
            className="flex items-center justify-between p-2.5 rounded-xl hover:bg-slate-800 focus:bg-slate-800 text-xs font-medium cursor-pointer text-blue-400"
          >
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span>Modo do Painel:</span>
            </div>
            <Badge className={isModoSimples ? "bg-amber-500/20 text-amber-300 border-amber-500/30 text-[10px]" : "bg-blue-500/20 text-blue-300 border-blue-500/30 text-[10px]"}>
              {isModoSimples ? "Simples" : "Completo"}
            </Badge>
          </DropdownMenuItem>
